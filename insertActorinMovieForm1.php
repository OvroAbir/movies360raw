...
<div id="bodyPan">
  <div id="leftPan">
    <h3>
      Please Insert the Name of the <span>Actor/Actress</span> and the Name of the <br /> <br /> Character they played in the Movie.<br /><br />
    </h3>
    <center>
    <form action="insertActorinMovieForm2.php" method="post">
      <p>
      <table cellspacing = "10px">
        <tr>
          <td>Actor Name &nbsp; </td>
          <td><input type="text" name="actorNameTextField" size="35" maxlength="40" value="" /></td>
        </tr>
        <tr>
          <td>Character Name &nbsp; </td>
          <td><input type="text" name="charNameTextField" size="35" maxlength="40" value="" /></td>
        </tr>
      </table>
    </p>
    </center>
        <p> 
          <center><input type="submit" name="insertButton" value="Add Actor" /> </center>
        </p>
    </form>
  </div>
  <div id="rightPan">
